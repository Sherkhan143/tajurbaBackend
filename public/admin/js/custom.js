...
$(document).ready(function () {
  ...
  var ssbutton = document.querySelectorAll('.switch')
...
// =========publish button js  start=============

var btnSw = document.querySelector('#play')
...
function switchBtn() {
  ...
  else if (btnSw.value == '1') {
    console.log('0')
    btnSw.value = '0';
  }
}
// =========publish button js end=============

// =========checkbox selector js start=============

function checkAll(ele) {
  var checkboxes = document.getElementsByTagName('input');
  var multiButtons = document.querySelectorAll('.multiButton');
  
  if (ele.checked && ele.classList.contains("multiCheck")) {
    ...
    for (var i = 0; i < multiButtons.length; i++) {
      multiButtons[i].removeAttribute("disabled")
    }

  }
  
  // else if(ele.checked && ele.classList.contains("singleCheck")){
  //   // if (checkboxes[i].type == 'checkbox') {
  //   //   checkboxes[i].checked = true;
  //   // }
  ...
  // }
    ...
    for (var i = 0; i < multiButtons.length; i++) {
      multiButtons[i].setAttribute("disabled", "disabled");
    }
  }
}
...
function changeButtonState(){
  ...
  for (var i = 0; i < multiButtons.length; i++) {
    ...
    if(multiButtons[i].hasAttribute("disabled")){
      multiButtons[i].removeAttribute("disabled")
    }
